        ...
        <div class="col-lg-3  col-md-6 col-sm-6">
          <div class="single-footer-widget mail-chimp">
            ...
            <ul class="instafeed d-flex flex-wrap">
              <li><img src="${pageContext.request.contextPath }/resources/img/instagram/i1.jpg" alt=""></li>
              <li><img src="${pageContext.request.contextPath }/resources/img/instagram/i2.jpg" alt=""></li>
              <li><img src="${pageContext.request.contextPath }/resources/img/instagram/i3.jpg" alt=""></li>
              <li><img src="${pageContext.request.contextPath }/resources/img/instagram/i4.jpg" alt=""></li>
              <li><img src="${pageContext.request.contextPath }/resources/img/instagram/i5.jpg" alt=""></li>
              <li><img src="${pageContext.request.contextPath }/resources/img/instagram/i6.jpg" alt=""></li>
              <li><img src="${pageContext.request.contextPath }/resources/img/instagram/i7.jpg" alt=""></li>
              <li><img src="${pageContext.request.contextPath }/resources/img/instagram/i8.jpg" alt=""></li>
            </ul>
          </div>
        </div>						
      </div>
