...
<table>
	<c:forEach items="${review }" var="review">
		<tr>
			<th>${review.restaurant_answer_writer }</th>
				<td width="80%">${review.restaurant_answer_content }</td>
			<th>${review.restaurant_answer_date }</th>
		</tr>
	</c:forEach>
</table>
</div>
...
<tr>
	<td>
		방문일 : <input type="date" name="restaurant_answer_enjoydate"/>
		<input type="text" id="restaurant_answer_point" name="restaurant_answer_point" value="0"/>
		<input type="text" name="restaurant_no" value="${list.restaurant_no }"> 
		<input type="text" name="restaurant_answer_writer" value="고상훈"/>
	</td>
</tr>
<tr><td><textarea rows="4" cols="100%" name="restaurant_answer_content"></textarea></td><td><input type="submit" value="작성" /></td></tr>
</table>
</form>
</div>
</section>
