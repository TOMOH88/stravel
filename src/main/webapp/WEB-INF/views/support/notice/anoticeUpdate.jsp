...
<div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
              				<form name="noticeForm" action="updateNotice.do" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                                <table class="table table-hover table-striped">
                                    <tr>
                                    <th class="success">TITLE</th>
                                     <td>
                                    <input type="text" name="notice_title" class="form-control" value="${notice.notice_title }">
                                    <input type="hidden" name="originalname_nfilename" value="${notice.originalname_nfilename }"/>
                                    <input type="hidden" name="rename_nfilename" value="${notice.rename_nfilename }"/>
                                    ...
                                    <td>
                                    <textarea cols="30" id="con1" name="notice_content" style="width:100%; height: 350px;">${notice.notice_content }</textarea>
                                    </td>
                                    </tr>
                                    <tr>
                                ...
                                <button class="btn btn-default btn-sm"  id="save">글 수정</button>
