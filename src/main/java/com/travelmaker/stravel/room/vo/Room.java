...
public class Room implements Serializable {
	...
	public Room(int roomNo, String roomName, int licenseNo, String roomTitle, String option, String roomContent,
			int minNo, int maxNo, int off_season_price, int on_season_price, int week_extra_price,
			int add_person_price, double discountRate) {
		super();
		this.roomNo = roomNo;
	...
	public String toString() {
		return roomNo + ", " +roomName+", " + licenseNo + ", " + roomTitle + ", " + option + ", " + roomContent + ", " + minNo + ", " + maxNo + ", " + 
