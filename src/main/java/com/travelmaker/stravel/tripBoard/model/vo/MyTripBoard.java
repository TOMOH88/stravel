...
public class MyTripBoard implements java.io.Serializable {
	...
	private String board_deletestatus;
	
	public MyTripBoard() {}

	public MyTripBoard(int board_no, String board_title, String board_writer, String board_content,
			String board_original_filename, String board_rename_filename, int board_read_count, Date board_write_date,
			int board_good_count, String board_deletestatus) {
		super();
		...
		this.board_deletestatus = board_deletestatus;
	}
	...
	public String getBoard_deletestatus() {
		return board_deletestatus;
	}

	public void setBoard_deletestatus(String board_deletestatus) {
		this.board_deletestatus = board_deletestatus;
	}
	...
	public String toString() {
		return "MyTripBoard [board_no=" + board_no + ", board_title=" + board_title + ", board_writer=" + board_writer
				+ ", board_content=" + board_content + ", board_original_filename=" + board_original_filename
				+ ", board_rename_filename=" + board_rename_filename + ", board_read_count=" + board_read_count
				+ ", board_write_date=" + board_write_date + ", board_good_count=" + board_good_count
				+ ", board_deletestatus=" + board_deletestatus + "]";
	}
